...
# 00 20 * * * Rscript /home/ubuntu/srv/my-statistical-health/imputeme/deletion_cron_job.R > /home/ubuntu/misc_files/cron_logs/`date +\%Y\%m\%d\%H\%M\%S`-delete-cron.log 2>&1
...
#   f1<-paste("/home/ubuntu/srv/my-statistical-health/www/",uniqueID,".23andme.zip",sep="")
#   f2<-paste("/home/ubuntu/srv/my-statistical-health/www/",uniqueID,".gen.zip",sep="")
...
unlink(list.files("/home/ubuntu/srv/my-statistical-health/www/",pattern="summary\\.xlsx$",full.names=T))